...
inline ArrayDetails validate(const H5::Group& handle, const ritsuko::Version& version, Callbacks& callbacks) {
    auto left_details = internal_arithmetic::fetch_seed(handle, "left", version, callbacks);
    auto right_details = internal_arithmetic::fetch_seed(handle, "right", version, callbacks);
