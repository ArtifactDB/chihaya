 ...
 */
inline ArrayDetails validate_binary_logic(const H5::Group& handle, const ritsuko::Version& version, Options& options) {
    ...
    if (!options.details_only) {
        ...
        const auto method = load_scalar_string_dataset(handle, "method");
