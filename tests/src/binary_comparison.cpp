...
public:
    BinaryComparisonTest() : path("Test_binary_comparison.h5") {}
protected:
    std::string path;

    static H5::Group binary_comparison_opener(H5::Group& handle, const std::string& name, const std::string& method, int version) {
